...
type Props = RootStackScreenProps<'HostData'>;
...
export function HostDataScreen({ navigation }: Props) {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle} numberOfLines={1}>Host Data</Text>
        <View style={{ width: 40 }} />
      </View>
          ...
          ListHeaderComponent={
            <>
              ...
              <View style={styles.cardsRow}>
                ...
                <SummaryCard
                  label="Stream Time"
                  value={`${Math.floor((income?.total_room_minutes ?? 0) / 60)}h ${(income?.total_room_minutes ?? 0) % 60}m`}
                  color={Colors.info}
                />
              </View>
  ...
  return (
    <View style={styles.gifterRow}>
      ...
      <View style={styles.gifterInfo}>
        <Text style={styles.gifterName} numberOfLines={1}>{entry.user.displayName}</Text>
