...
async function main() {
  ...
  const MOMENTS: Array<{
    ...
    { id: 'f0000007-0000-4000-8000-000000000007', userId: IDS.host2,  postType: 'video',  mediaUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=430&h=932&fit=crop', caption: 'Just wrapped up a 3-hour stream 🎤 Thank you to everyone who sent gifts tonight! #HakaLive #Lagos', hashtag: '#HakaLive',       likesCount: 1840, commentsCount: 2, sharesCount: 45,  giftsCount: 67,  createdAt: hoursAgo(4) },
    { id: 'f0000008-0000-4000-8000-000000000008', userId: IDS.host1,  postType: 'video',  mediaUrl: 'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=430&h=932&fit=crop', caption: 'Bollywood night was INCREDIBLE 💃🔥 2,000 beans earned in one session!! #BollywoodNights',         hashtag: '#BollywoodNights',likesCount: 3200, commentsCount: 3, sharesCount: 89,  giftsCount: 134, createdAt: hoursAgo(6) },
    { id: 'f0000009-0000-4000-8000-000000000009', userId: IDS.host3,  postType: 'video',  mediaUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=430&h=932&fit=crop', caption: 'Late night DJ set from Manila 🎧🌙 New Afro x Filipino fusion mix dropping Friday',              hashtag: '#DJLife',         likesCount: 980,  commentsCount: 1, sharesCount: 32,  giftsCount: 28,  createdAt: hoursAgo(8) },
    { id: 'f0000010-0000-4000-8000-000000000010', userId: IDS.ihost1, postType: 'video',  mediaUrl: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=430&h=932&fit=crop', caption: 'Behind the scenes of our Golden Phoenix family meetup in Mexico City 🔥👑',                        hashtag: '#GoldenPhoenix',  likesCount: 6100, commentsCount: 2, sharesCount: 210, giftsCount: 156, createdAt: hoursAgo(10) },
    { id: 'f0000011-0000-4000-8000-000000000011', userId: IDS.ihost2, postType: 'video',  mediaUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=430&h=932&fit=crop', caption: 'First week on Haka and already got 200 followers! This community is amazing 🙏',                 hashtag: '#NewHere',        likesCount: 245,  commentsCount: 1, sharesCount: 8,   giftsCount: 5,   createdAt: hoursAgo(12) },
  ];
