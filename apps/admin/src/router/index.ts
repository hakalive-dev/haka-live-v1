  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'rank-management', redirect: '/rank-management/activity' },
        { path: 'rank-management/activity', name: 'RankingRewardsActivity', component: () => import('@/views/rank-management/RankingRewardsView.vue'), props: { board: 'creator' } },
        { path: 'rank-management/agent', name: 'RankingRewardsAgent', component: () => import('@/views/rank-management/RankingRewardsView.vue'), props: { board: 'agent' } },
        { path: 'rank-management/state-ranking', name: 'StateRanking', component: () => import('@/views/rank-management/StateRankingView.vue') },
        { path: 'gifts/state-ranking', redirect: '/rank-management/state-ranking' },
        { path: 'gifts/ranking-rewards', redirect: '/rank-management/activity' },
        { path: 'gifts/ranking-rewards/activity', redirect: '/rank-management/activity' },
        { path: 'gifts/ranking-rewards/agent', redirect: '/rank-management/agent' },
