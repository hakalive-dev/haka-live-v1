  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'gifts/ranking-rewards', redirect: '/gifts/ranking-rewards/activity' },
        { path: 'gifts/ranking-rewards/activity', name: 'RankingRewardsActivity', component: () => import('@/views/gifts/RankingRewardsView.vue'), props: { board: 'creator' } },
        { path: 'gifts/ranking-rewards/agent', name: 'RankingRewardsAgent', component: () => import('@/views/gifts/RankingRewardsView.vue'), props: { board: 'agent' } },
